    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/auth/**", "/api/customer/**", "/api/chatbot/**", "/api/public-translations/**", "/api/menu/**", "/api/categories/active", "/api/promotions/active", "/api/system-settings/public", "/api/payments/payos/webhook", "/uploads/**", "/ws/**", "/ws").permitAll()
